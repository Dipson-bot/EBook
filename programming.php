...
// Fetch and display books from the 'programming' category
$category = 'programming'; // Replace 'programming' with the category you want to display
...
<body>
    ...
    <div class="container col-12 m-5">
        <div class="col-12 m-auto">
            <h2 class="text-center">Programming Books</h2>
