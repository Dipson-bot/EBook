...
// Fetch and display books from the 'scifi' category
$category = 'scifi'; // Replace 'scifi' with the category you want to display
...
<body>
    ...
    <div class="container col-12 m-5">
        <div class="col-12 m-auto">
            <h2 class="text-center">Science Fiction Books</h2>
