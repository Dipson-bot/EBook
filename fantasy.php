...
// Fetch and display books from the 'fantasy' category
$category = 'fantasy'; // Replace 'fantasy' with the category you want to display
...
<body>
    ...
    <div class="container col-12 m-5">
        <div class="col-12 m-auto">
            <h2 class="text-center">Sem-1 Books</h2>
