...
// Fetch and display books from the 'adventure' category
$category = 'adventure'; // Replace 'adventure' with the category you want to display
...
<body>
    ...
    <div class="container col-12 m-5">
        <div class="col-12 m-auto">
            <h2 class="text-center">AdventurNotera</h2>
